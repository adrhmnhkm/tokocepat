    ...
    <div className="bg-slate-50 text-slate-900 font-sans antialiased">
      ...
      <header className="pt-20 pb-16 bg-gradient-to-br from-green-50 via-slate-50 to-blue-50 relative overflow-hidden">
        ...
        <div className="w-[min(1100px,90%)] mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-1.5 bg-green-100 text-green-800 text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full border border-green-200 mb-5">
              <span className="w-1.5 h-1.5 rounded-full bg-green-600" />
              Khusus Seller Indonesia
            </div>
            <h1 className="text-[clamp(2rem,5.5vw,3.2rem)] font-extrabold leading-tight text-slate-950 mb-5">
              Jualan Online{" "}
      ...
      <section id="problem" className="py-20 bg-slate-950">
        <div className="w-[min(1100px,90%)] mx-auto">
          <span className="text-xs font-bold uppercase tracking-widest text-red-400">Masalah yang Sering Terjadi</span>
          ...
          <div className="grid sm:grid-cols-2 gap-3.5">
            {[
              ...
              <div
                key={item.title}
                className="flex gap-4 items-start bg-white/5 border border-white/8 rounded-xl p-5 hover:border-red-400/30 transition-colors"
              >
                <div className="w-10 h-10 rounded-xl bg-red-400/15 grid place-items-center text-lg flex-shrink-0">
                  {item.icon}
                </div>
                <div>
      ...
      <section id="solution" className="py-20 bg-gradient-to-br from-green-50 via-white to-white">
        <div className="w-[min(1100px,90%)] mx-auto">
          <span className="text-xs font-bold uppercase tracking-widest text-green-600">Solusi & Fitur Utama</span>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={f.title} className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
                <div className="w-12 h-12 bg-green-100 border border-green-200 rounded-xl grid place-items-center text-2xl mb-4">
                  {f.icon}
                </div>
      ...
      <section id="steps" className="py-20 bg-white">
        <div className="w-[min(1100px,90%)] mx-auto">
          <span className="text-xs font-bold uppercase tracking-widest text-green-600">Cara Kerja</span>
          <h2 className="text-[clamp(1.5rem,3.5vw,2.1rem)] font-extrabold mt-2 mb-3">
      ...
      <section id="testimoni" className="py-20 bg-slate-50">
        <div className="w-[min(1100px,90%)] mx-auto">
          <span className="text-xs font-bold uppercase tracking-widest text-green-600">Testimoni</span>
          <h2 className="text-[clamp(1.5rem,3.5vw,2.1rem)] font-extrabold mt-2 mb-3">
            Seller Indonesia sudah pakai
          </h2>
          <p className="text-slate-500 mb-10 max-w-xl">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={t.name} className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all">
                <div className="text-yellow-400 text-sm tracking-widest mb-3">★★★★★</div>
                <blockquote className="text-[0.95rem] text-slate-700 leading-relaxed mb-5">
                  &ldquo;{t.quote}&rdquo;
                </blockquote>
                <div className="flex items-center gap-2.5">
                  <div className="w-9 h-9 rounded-full bg-gradient-to-br from-green-500 to-green-400 grid place-items-center text-white font-bold text-sm">
                    {t.initial}
                  </div>
                  <div>
      ...
      <section id="faq" className="py-20 bg-slate-50">
        <div className="w-[min(1100px,90%)] mx-auto">
          <span className="text-xs font-bold uppercase tracking-widest text-green-600">FAQ</span>
          ...
          <div className="flex flex-col gap-2.5 max-w-2xl">
            {[
              ...
              <details key={item.q} className="group bg-white border border-slate-200 rounded-xl overflow-hidden open:shadow-md transition-shadow">
                <summary className="flex justify-between items-center px-5 py-4 font-bold text-sm cursor-pointer list-none">
                  {item.q}
                  <span className="text-green-600 text-xl font-bold group-open:rotate-45 transition-transform ml-4 flex-shrink-0">+</span>
                </summary>
